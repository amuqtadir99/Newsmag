      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-12 text-center mb-3">
            <p className="mb-1">
              <span className="fw-semibold">Made with ♡ Abdul Muqtadir</span>
              <span className="small"> @witwebsolutions</span>
            </p>
            <a 
          ...
          <div className="col-12 text-center">
            <div className="d-flex justify-content-center align-items-center gap-3">
              ...
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="me-1">
        ...
        <div className="row mt-3 pt-3 border-top border-secondary">
          <div className="col-12 text-center">
            <p className="mb-0 text-muted small">
              © {new Date().getFullYear()} NewsMag. All rights reserved.
            </p>
          </div>
        </div>
      </div>
